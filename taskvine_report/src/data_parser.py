...
class DataParser:
    def __init__(self,
        ...
        self.downsample_task_count = downsample_task_count
        self.downsample_point_count = downsample_point_count

        if not self.downsampling:
            self.downsample_task_count = sys.maxsize
            self.downsample_point_count = sys.maxsize
