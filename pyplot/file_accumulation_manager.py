...
def plot_manager_disk_usage(show=True):
    ...
    for i, csv_file in enumerate(MANAGER_DISK_USAGE_CSV_FILES):
        ...
        df['accumulated_disk_usage_gb'] = df['accumulated_disk_usage(MB)'] / \
            1024
        ...
        ax.set_ylabel('Manager Storage Consumption (GB)',
    ...
    plt.savefig(os.path.join(
        SAVE_TO, 'Manager_Disk_Usage_Comparison.png'), bbox_inches='tight')
