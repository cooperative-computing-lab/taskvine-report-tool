...
def get_subgraphs():
    try:
        ...
        svg_file_path_without_suffix = os.path.join(runtime_state.svg_files_dir, f'subgraph-{subgraph_id}-{plot_unsuccessful_task}-{plot_recovery_task}')
        ...
        data['subgraph_num_tasks_list'] = [len(subgraph) for subgraph in runtime_state.subgraphs.values()]
