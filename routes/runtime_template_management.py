...
runtime_template_management_bp = Blueprint('runtime_templates_list', __name__, url_prefix='/api')
...
@runtime_template_management_bp.route('/runtime-templates-list')
...
@runtime_template_management_bp.route('/change-runtime-template')
...
@runtime_template_management_bp.route('/logs/<runtime_template>')
